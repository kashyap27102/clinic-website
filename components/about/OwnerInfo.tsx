  ...
  return (
    <>
      <div className="text-center mb-12">
        <p className="text-primaryDark uppercase tracking-widest">MEET OUR</p>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 bg-primaryDark text-white rounded-lg gap-4">
        <div className="col-span-1 lg:col-span-2 p-6 space-y-4">
          ...
          <p className="text-base text-justify">
            ...
            physiotherapist in Gandhinagar, with more than 2 years of experience
            in the field. He is providing quality care to patients of all ages,
            ranging from children to elders. In addition to his clinical work,
            he is also the director of World of Rehab, a leading physiotherapy
            clinic in Gandhinagar that provides innovative and effective
